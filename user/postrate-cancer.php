    ...
    <div class="container" id="experttest1">
        ...
        <div class="row">
            ...
            <div class="text-center" style="margin-top: 20px;">
                <a href="homepage.php" class="btn btn-primary">Diagnosed for Breast Cancer</a>
            </div>
            <h3>Postrate Cancer</h3>
            <div class="col-sm-12 col-md-offset-2 col-md-8 jumbotron form-horizontal" id="experttest2">
                <?php
                $b = 0;
                $select = "SELECT * FROM postrate_cancer"; // Ensure this is fetching from postrate_cancer
...
<script type="text/javascript" src="../js/postrate_script.js"></script>
